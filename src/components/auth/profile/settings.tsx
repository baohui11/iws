...
import ProfileInfoFields from "@/components/auth/profile/info-fields";
import ProfilePasswordSection from "@/components/auth/profile/password-section";
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-8 md:py-12">
      ...
      <div className="flex flex-col gap-6">
        <Card shadow="sm" className="border border-default-200/80 dark:border-default-100">
          ...
          <CardBody className="px-6 pb-6 pt-4">
            <AvatarUpload initialSrc={profile.avatar_url} name={profile.name} />
          </CardBody>
        </Card>
