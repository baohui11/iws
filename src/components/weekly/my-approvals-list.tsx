...
import { loadPmApprovalList } from '@/actions/weekly/reports.action'
import WeekMultiSelect from '@/components/weekly/filters/week-multi-select'
import ProjectMultiSelect from '@/components/weekly/filters/project-multi-select'
...
export default function MyApprovalsList({
  ...
  const fetchData = useCallback(
    async (state: WeeklyApprovalsUrlState) => {
      setIsLoading(true)
      const result = await loadPmApprovalList({
