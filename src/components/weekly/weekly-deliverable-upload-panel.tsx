...
import { uploadDeliverableFileAction } from '@/actions/weekly/file-upload.action'
import DeliverableReferencePickerModal from '@/components/weekly/deliverable-reference-picker-modal'
import FileTypeIcon from '@/components/weekly/file-type-icon'
import FileUploadInteractionIcons from '@/components/weekly/file-upload-interaction-icons'
import {
...
import { fileExtLower, getBasenameOnly } from '@/lib/utils/safe-upload-filename'
import type {
