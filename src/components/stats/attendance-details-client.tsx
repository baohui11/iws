...
import { loadAttendanceDetails } from '@/actions/stats/attendance-stats.action'
import type { AttendanceDetailRow } from '@/types/stats'
...
export default function AttendanceDetailsClient({
  ...
  const runQuery = useCallback(async () => {
    setLoading(true)
    const result = await loadAttendanceDetails(departmentId, yearMonth)
    setLoading(false)
