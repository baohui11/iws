...
import { loadAttendanceSummary } from '@/actions/stats/attendance-stats.action'
import type { AttendanceSummaryRowPerson } from '@/types/stats'
...
export default function AttendanceSummaryClient({
  ...
  const runQuery = useCallback(async () => {
    setLoading(true)
    const result = await loadAttendanceSummary(departmentId, yearMonth)
    setLoading(false)
    ...
    setRowsPerson(result.data as AttendanceSummaryRowPerson[])
