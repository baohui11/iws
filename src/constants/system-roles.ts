...
export function parseSystemRole(value: string | null | undefined): SystemRoleValue | null {
  if (value == null || value === '') return null
  const t = value.trim()
  return SYSTEM_ROLE_VALUES.includes(t as SystemRoleValue) ? (t as SystemRoleValue) : null
}

export function defaultSystemRole(value: string | null | undefined): SystemRoleValue {
