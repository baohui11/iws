import type { DepartmentNode } from './repo'
...
export function formatDepartmentPathLabel(
  ...
  return parts.length ? parts.join(' / ') : fallbackName?.trim() || '—'
}
