  ...
  return (
    ...
    >
      ...
      <NavbarBrand>
        ...
        />
        <span className="ml-2 text-lg font-bold">周报文件系统</span>
      </NavbarBrand>
      ...
      <NavbarMenu className="bg-default-200/50 shadow-medium dark:bg-default-100/50 top-[calc(var(--navbar-height)-1px)] max-h-[80vh] pt-4 pb-6 backdrop-blur-md backdrop-saturate-150">
        {visibleNav.map((item) => {
          ...
          return (
            <div key={item.href} className="mb-2">
              <NavbarMenuItem>
                <Link
                  ...
                  className={cn(
                    ...
                    isParentActive ? 'text-primary font-semibold' : 'text-default-600'
                  )}
                >
                  <span
                    className={cn(
                      'mr-3 h-2 w-2 rounded-full',
                      isParentActive ? 'bg-primary' : ''
                    )}
                  />
                  {item.label}
                </Link>
              ...
              {item.children && isParentActive && (
                <div className="border-default-200 ml-5 border-l-2 pl-4">
                      ...
                      <NavbarMenuItem key={child.href}>
                        <Link
                          ...
                          className={cn(
                            ...
                            isChildActive ? 'text-primary font-medium' : 'text-default-500'
                          )}
                        >
                          <span
                            className={cn(
